                ...
                <div className="container mx-auto flex flex-wrap items-center">
                    <div className="flex w-full md:w-1/2 justify-center md:justify-start font-extrabold">
                        <a className="no-underline hover:text-cyan hover:no-underline" href="/">
                            <span className="text-4xl text-cyan-600 pl-2 hover:text-cyan-500" id="nav1">
                    ...
                    <div className="flex w-full pt-2 content-center justify-between md:w-1/2 md:justify-end">
                        <ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
                            <li className="mr-3">
                                <a id="nav" className="inline-block text-xl font-semibold  no-underline text-cyan-600 hover:text-cyan-500 hover:text-underline py-2 px-2" href="/">home</a>
                            </li>
                            <li className="mr-3">
                                <a id="nav" className="inline-block text-xl font-semibold  no-underline text-cyan-600 hover:text-cyan-500 hover:text-underline py-2 px-2" href="/about">about</a>
                            </li>
                            {/* <li className="mr-3">
                            ...
                            <li className="mr-3">
                                <a id="nav" className="inline-block text-xl font-semibold  no-underline text-cyan-600 hover:text-cyan-500 hover:text-underline py-2 px-2" href="/projects">projects</a>
                            </li>
                        </ul>
                    </div>
                </div>
