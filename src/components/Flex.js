    ...
    return (
        <div className="simple">
            <div className="container w-full mx-auto mt-16">
                <div className=" p-20 flex flex-wrap items-center align-middle justify-center">
...
<div className="h-24 w-24 grow rounded shadow bg-yellow-700">1</div>
<div className="h-16 w-16 grow rounded shadow bg-yellow-700">1</div>
<div className="h-16 w-16 grow rounded shadow bg-yellow-700">1</div>
<div className="h-24 w-24 grow rounded shadow bg-yellow-700">1</div>
<div className="h-24 w-24 grow rounded shadow bg-yellow-700">1</div>
<div className="h-16 w-16 grow rounded shadow bg-yellow-700">1</div>
...
<div className="grid grid-cols-6 gap-4 ">
    ...
    <div className="h-16 w-40 grow rounded shadow bg-yellow-900">1</div>
    <div className="h-16 w-40 grow rounded shadow bg-yellow-900">1</div>
    <div className="h-16 w-40 grow col-start-3 rounded shadow bg-yellow-900">1</div>
</div>
