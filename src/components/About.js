            ...
            <div className="about p-6  md:p-28 flex flex-wrap">
                ...
                <div className=" sm:w-full md:w-1/3  mt-0 md:pr-10 md:pl-2 py-2 order-1 md:order-1">
                    ...
                    <div className="bg-stone-600/50 p-6 backdrop-blur-sm shadow-xl rounded-2xl  md:float-right text-right leading-loose tracking-tight sticky mt-24 md:mt-0 md:top-16 ">
                        ...
                        <ul className="pt-4 flex flex-wrap justify-between flex-col">
                            <li><p className="text-stone-500">hi, i'm allison durham</p></li>
                            <li><p className="text-stone-500">i love to code</p></li>
                ...
                <div className="w-full py-2 md:w-2/3 order-4 md:order-4">
                    <div className="bg-stone-600/50 backdrop-blur-sm shadow-xl p-6 mb-12 md:mb-0 md:mt-12 rounded-2xl max-w-3xl leading-loose tracking-tight">
                        ...
                        <p className="mb-8 text-stone-500">i built this site with react, which i'd never used before, but wanted to try it out and needed to build a place for my portfolio anyhow.  i love how much faster it is than a similar django project would be, and as much as i love python (which is a lot), i've been having a lot of fun lately with javaScript. i think this site turned out okay! it's always fun to learn something new, and if you hire me, i'll learn whatevers in your stack!</p>
                    </div>
                </div>
