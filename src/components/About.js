...
import image from "../assets/drawing.jpg";
    ...
    return (
        <div className="">
            {/* <div className="container w-full mx-auto mt-16">
                ...
                <div class="p-6 sm:p-10 md:p-28 flex flex-wrap">

<div class="w-full md:w-1/2 md:pr-32 pl-16 order-3 md:order-1">
    <div class="max-w-md md:float-right md:text-right leading-loose tracking-tight md:sticky md:top-0 ">
        <p class="font-bold my-4 md:my-8">Left column pic and links</p>

        <img className="rounded" src={image} alt=""/>

        <ul class="pt-4 flex flex-wrap justify-between flex-col">
            <li><a href="#" className=" hbout">super cool interesting link</a></li>
            <li><a href="#" class="hbout">probably very helpful and worthwhile link</a></li>
            <li><a href="#" class="hbout">someone might click on this one day link</a></li>
            <li><a href="#" class="hbout">another link</a></li>
        </ul>
        <a href="#" class="hbout normal font-bold hover:font-bold">more...</a>
    </div>
</div>
<div class="w-full md:w-1/2 order-1 md:order-2">
    <div class="max-w-md leading-loose tracking-tight">
        <h1 class="font-bold my-12">Right Column</h1>
...
<div class="w-full md:w-1/2 md:pr-32 mt-4 pt-12 md:pt-20  md:bottom-0 order-4 md:order-3">
    <div class="max-w-md md:float-right md:text-right leading-loose tracking-tight md:mb-6">
        <p class="font-bold my-4 md:mt-12 md:mb-4">More Info</p>

        <ul class="flex flex-wrap  justify-between flex-row ">
            <li><a href="#" class="hbout mx-2 ">Twitter</a></li>
            <li><a href="#" class="hbout mx-2 ">Instagram</a></li>
            <li><a href="#" class="hbout mx-2 ">Social</a></li>
            <li><a href="#" class="hbout mx-2 ">Media</a></li>
        </ul>
    </div>
</div>
...
<div class="w-full md:w-1/2 order-2 md:order-4">
    <div class="max-w-md leading-loose tracking-tight">
        <p class="font-bold my-4 md:my-12">Final Blurb</p>

        <p class="mb-8">Typewriter mlkshk la croix, unicorn poutine before they sold out coloring book vaporware +1 PBR&B tumblr iceland hoodie poke semiotics. Irony whatever before they sold out umami green juice.</p>
    </div>
</div>
