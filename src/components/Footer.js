            ...
            <footer className="text-center foot lg:text-left  w-full text-yellow-900 fixed bottom-0 z-10">
                <div className="flex justify-center items-center lg:justify-between px-6 py-3 border-b border-stone-900 ">
                    ...
                    <div className="flex justify-center">
                        <a href="https://www.facebook.com/allison.m.durham" className="mr-6 text-yellow-900">
                        ...
                        <a href="https://twitter.com/amdurham522" className="mr-6 text-yellow-900" >
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" className="w-5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <a href="https://www.google.com/" className="mr-6 text-yellow-900">
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" className="w-5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
                                <path fill="currentColor" className="hover:fill-cyan-600" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z">
                                </path>
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/amdurham522/" className="mr-6 text-yellow-900">
                        ...
                        <a href="https://www.linkedin.com/in/allisondurham/" className="mr-6 text-yellow-900">
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin-in" className="w-5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        ...
                        <a href="https://github.com/allisondurham/" className="text-yellow-900">
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" className="w-5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                ...
                {/* <div className="px- py-6 text-center md:text-left border-b border-yellow-800">
                    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                        ...
                        <div className="col-span-1">
                            <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">cheeses
                            </h6>
                            <p className="mb-4">
                                <a href="https://en.wikipedia.org/wiki/Brie" className="text-yellow-900" id="foot">Brie</a>
                            </p>
                            <p className="mb-4">
                                <a href="https://en.wikipedia.org/wiki/Muenster_cheese" className="text-yellow-900" id="foot">Muenster</a>
                            </p>
                            <p className="mb-4">
                                <a href="https://en.wikipedia.org/wiki/Cheddar_cheese" className="text-yellow-900" id="foot">Cheddar</a>
                            </p>
                            <p>
                                <a href="https://en.wikipedia.org/wiki/Gouda_cheese" className="text-yellow-900" id="foot">Gouda</a>
                            </p>
                        </div>
                        <div className="col-span-1">
                            ...
                            <p className="mb-4">
                                <a href="https://www.pexels.com/" className="text-yellow-900" id="foot">Stock Photos</a>
                            </p>
                            <p className="mb-4">
                                <a href="https://www.spotify.com/" className="text-yellow-900" id="foot">Music</a>
                            </p>
                            <p className="mb-4">
                                <a href="https://www.youtube.com" className="text-yellow-900" id="foot">Videos</a>
                            </p>
                            <p>
                                <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=RickAstley" className="text-yellow-900" id="foot">Rick Roll</a>
                            </p>
                        </div>
                        <div className="col-span-2">
                            <h6 className="uppercase font-semibold mb-4 ml-6 flex justify-center md:justify-start">
                            Contact
                            </h6>
