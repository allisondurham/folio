...
export default function Footer({ fixed }) {
    return (
        <div class="footer">
<footer class="text-center lg:text-left bg-gradient-to-r from-yellow-700 to-yellow-400 text-gray-600">
  <div class="flex justify-center items-center lg:justify-between p-6 border-b border-yellow-800">
    <div class="ml-6 hidden lg:block">
      <span>Popular social networks:</span>
    </div>
    <div class="flex justify-center">
      <a href="https://facebook.com/" class="mr-8 text-gray-600">
      ...
      <a href="https://www.twitter.com/" class="mr-8 text-gray-600">
      ...
      <a href="https://www.google.com/" class="mr-8 text-gray-600">
      ...
      <a href="https://www.instagram.com/" class="mr-8 text-gray-600">
      ...
      <a href="https://linkedin.com/" class="mr-8 text-gray-600">
  ...
  <div class="mx-6 py-10 text-center md:text-left border-b border-yellow-800">
  ...
  <div class="text-center p-6 bg-gradient-to-r from-yellow-700 to-yellow-400">
    <span>© 2021 Copywrong:  </span>
    <a class=" text-gray-600 font-semibold" href="https://tailwind-elements.com/">Make this text scroll across the bottom</a>
  </div>
</footer>
        </div>
    );
