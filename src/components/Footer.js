        ...
        <div className="footer ">
            <footer className="text-center foot lg:text-left  w-full fixed bottom-0 z-10">
                <div className="flex justify-center items-center lg:justify-between px-6 py-3 border-b border-stone-900 ">
                    ...
                    <a href="mailto:allison.durham@gmail.com" className="mr-6">
                            <svg width="1.6em" height="1.6em" viewBox="0 0 16 16" class="bi bi-envelope" fill="currentColor" className="w-7 pb-1" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2zm13 2.383l-4.758 2.855L15 11.114v-5.73zm-.034 6.878L9.271 8.82 8 9.583 6.728 8.82l-5.694 3.44A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.739zM1 11.114l4.758-2.876L1 5.383v5.73z"/>
                            </svg>
                        </a>

                        <a href="https://www.facebook.com/allison.m.durham" className="mr-6 ">
                        ...
                        <a href="https://twitter.com/amdurham522" className="mr-6 " >
                        ...
                        <a href="https://www.instagram.com/amdurham522/" className="mr-6 ">
                        ...
                        <a href="https://www.linkedin.com/in/allisondurham/" className="mr-6 ">
                        ...
                        <a href="https://github.com/allisondurham/" className="">
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" className="w-6" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
