            ...
            <footer className="text-center lg:text-left bg-gradient-to-r from-yellow-700 to-yellow-400 text-yellow-900">
                <div className="flex justify-center items-center lg:justify-between px-6 py-3 border-b border-yellow-800">
                    ...
                    <div className="flex justify-center">
                        ...
                        <a href="https://www.twitter.com/" className="mr-6 text-yellow-900" >
                        ...
                        <a href="https://www.instagram.com/" className="mr-6 text-yellow-900">
                        ...
                        <a href="https://linkedin.com/" className="mr-6 text-yellow-900">
                        ...
                        <a href="https://github.com/" className="text-yellow-900">
                ...
                <div className="text-center py-4 bg-gradient-to-r from-yellow-700 to-yellow-400">
